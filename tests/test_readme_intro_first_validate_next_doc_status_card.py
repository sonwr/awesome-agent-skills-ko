...
class ReadmeIntroFirstValidateNextDocStatusCardTest(unittest.TestCase):
    def test_note_exists_with_intro_first_three_part_handoff(self) -> None:
        note = (ROOT / "docs" / "README_INTRO_FIRST_VALIDATE_NEXT_DOC_STATUS_CARD.md").read_text(encoding="utf-8")
